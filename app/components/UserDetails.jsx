	...
	return (
		<div>
			...
			<li className="list-group-item text-center">
				<img src={user.info.avatar_url} className="img-rounded img-responsive" style={styles.img}></img>
			</li>
			...
			{user.info.blog && <li className="list-group-item">Blog: <a href={user.info.blog}>{user.info.username} Blog</a></li>}
			</div>
	);
}
